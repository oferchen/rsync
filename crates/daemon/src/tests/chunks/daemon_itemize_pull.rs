/// End-to-end test for itemize (`-i`) output in daemon pull mode.
///
/// Verifies that when verbosity is enabled during a pull transfer from an
/// oc-rsync daemon, the client collects events with correct kinds and relative
/// paths for both newly created and updated files.
///
/// # Scenario
///
...
///
/// After pull with verbosity=1, the client should report DataCopied events for
...
#[cfg(unix)]
#[test]
#[ignore = "task 1246: pull of a new file emits no DataCopied itemize event"]
