...
include!("tests/chunks/daemon_per_module_cap_wire_bytes_match_global_path.rs");
...
// Daemon dry-run push end-to-end tests
include!("tests/chunks/daemon_dry_run_push.rs");
include!("tests/chunks/daemon_dry_run_push_across_protocol_versions.rs");
...
// Daemon rejects a pre-existing `rsyncd-munged` directory under munge symlinks
include!("tests/chunks/daemon_munge_symlinks_rejects_preexisting_munged_dir.rs");
...
include!("tests/chunks/runtime_options_loads_syslog_tag_from_config.rs");
...
include!("tests/chunks/runtime_options_last_wins_reverse_lookup.rs");
...
include!("tests/chunks/runtime_options_loads_auth_users_without_a_secrets_file.rs");
