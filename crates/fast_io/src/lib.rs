...
pub use dir_sandbox::{
    ...
    renameat_via_sandbox_or_fallback, secure_chmod_at, secure_chmod_at_dirfd, secure_chown_at,
    secure_chown_at_dirfd, secure_utimes_at, secure_utimes_at_dirfd, symlinkat,
