...
pub use legacy::{
    ...
    format_daemon_auth_response, format_daemon_module_listing, format_legacy_daemon_greeting,
    format_legacy_daemon_message, is_version_banner, missing_greeting_token,
    parse_daemon_auth_response, parse_daemon_module_listing, parse_legacy_daemon_greeting,
