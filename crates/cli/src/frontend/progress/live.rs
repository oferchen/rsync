...
///
/// upstream: options.c:2018-2040 `--outbuf` controls stdout buffering via
...
impl<'a> ClientProgressObserver for LiveProgress<'a> {
    ...
    fn on_progress(&mut self, update: &ClientProgressUpdate) {
        ...
        // upstream: receiver.c:690-692 - the NDX_DONE end_progress(0) summary
            ...
            ProgressMode::Overall => (|| -> io::Result<()> {
                ...
                if is_final {
                    ...
                    if final_tick {
                        ...
                        // is deferred until the summary (main.c:455). We emit
