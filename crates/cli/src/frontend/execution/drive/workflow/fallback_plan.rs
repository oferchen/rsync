...
pub(crate) struct FallbackArgumentsContext<'a> {
    ...
    pub(crate) sockopts: Option<&'a OsString>,
    ...
    Err: Write,
{
    ...
    let fallback_inputs = fallback::FallbackInputs {
        ...
        delete_missing_args: context.delete_missing_args,
        ...
        sockopts: context.sockopts.cloned(),
        blocking_io: context.blocking_io,
        human_readable: context.human_readable,
        archive: context.archive,
        recursive_override: context.recursive_override,
        inc_recursive: context.inc_recursive,
        dirs: context.dirs,
        delete_for_fallback,
        ...
        ignore_times: context.ignore_times,
        ...
        owner: context.owner,
        group: context.group,
        usermap: context.usermap.cloned(),
        groupmap: context.groupmap.cloned(),
        ...
        copy_devices: context.copy_devices,
        write_devices: context.write_devices,
        ...
        stats: context.stats,
        eight_bit_output: context.eight_bit_output,
