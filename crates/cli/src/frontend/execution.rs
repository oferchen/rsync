...
use rsync_core::{
    ...
    client::{
        ...
        HumanReadableMode, ModuleList, ModuleListOptions, ModuleListRequest, RemoteFallbackArgs,
...
use super::{
    ...
    defaults::{ITEMIZE_CHANGES_FORMAT, SUPPORTED_OPTIONS_LIST},
    filter_rules::{
    ...
    password::{load_optional_password, load_password_file},
    progress::{LiveProgress, NameOutputLevel, ProgressSetting, emit_transfer_summary},
    render_help, write_message,
};
...
pub(super) fn info_flags_include_progress(flags: &[OsString]) -> bool {
...
pub(super) const INFO_HELP_TEXT: &str = "The following --info flags are supported:\n\
...
pub(super) const DEBUG_HELP_TEXT: &str = "The following --debug flags are supported:\n\
