...
#[cfg(unix)]
#[test]
fn remote_fallback_forwards_stop_after_argument() {
...
"#;
    ...
    assert!(recorded.lines().any(|line| line == "--stop-after=5"));
}

#[cfg(unix)]
#[test]
fn remote_fallback_forwards_stop_at_argument() {
    use tempfile::tempdir;
...
"#;
    ...
    assert!(
        recorded
            .lines()
            .any(|line| line == "--stop-at=2099-12-31T23:59")
    );
}
