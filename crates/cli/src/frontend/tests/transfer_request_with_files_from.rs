...
/// # Upstream Reference
///
/// - `flist.c:2476-2503` - `send_file_list()` reads from `filesfrom_fd`
...
/// recursion is off, matching upstream `flist.c:2682`.
///
...
/// - `flist.c:2569` - SLASH_ENDING_NAME / DOTDIR_NAME flagging
