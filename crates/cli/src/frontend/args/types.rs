//! Data structures describing parsed command-line arguments.
...
use super::super::program::ProgramName;
use super::super::progress::{NameOutputLevel, ProgressSetting};

/// Tracks whether bandwidth limiting was requested or explicitly disabled.
#[derive(Clone, Debug, Eq, PartialEq)]
pub(crate) enum BandwidthArgument {
    /// A concrete limit provided by the user.
    Limit(OsString),
    /// Explicit request to disable bandwidth limiting.
    Disabled,
}

/// Complete set of parsed arguments produced by the CLI frontend.
