...
//! # Overview
//!
//! `oc_rsync_engine` hosts transfer-oriented building blocks that power the Rust
...
//! while preserving permissions and timestamps through the [`oc_rsync_meta`]
...
//! # See also
//!
//! - `oc_rsync_core::client` integrates the plan builder to power the `rsync`
