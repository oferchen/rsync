...
//! and strong checksum primitives exposed by `oc_rsync_checksums`. The resulting
...
//!   [`SignatureLayout`].
//! - [`oc_rsync_checksums`] for the rolling and strong checksum implementations
...
use oc_rsync_checksums::RollingDigest;
use oc_rsync_checksums::strong::{Md4, Md5, Sha1, StrongDigest, Xxh3, Xxh3_128, Xxh64};
