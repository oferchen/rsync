...
mod tests {
    ...
    // --- Error-injection convergence tests (#2092) ---

    /// Helper: completes one full success window (target consecutive successes).
    ...
    /// Helper: injects one overload signal, sleeping briefly to bypass debounce.
