...
///
/// ```
/// use oc_rsync_core::{message::SourceLocation, message_source_from};
///
...
///
/// ```
/// use oc_rsync_core::{message::SourceLocation, tracked_message_source};
///
/// #[track_caller]
...
///
/// ```
/// use oc_rsync_core::{message::Role, rsync_error};
///
...
///
/// ```
/// use oc_rsync_core::rsync_warning;
///
...
///
/// ```
/// use oc_rsync_core::{message::Role, rsync_exit_code};
///
/// fn render() -> oc_rsync_core::message::Message {
