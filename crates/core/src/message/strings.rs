...
//!
//! ```
//! use core::message::strings::exit_code_message;
//!
//! let template = exit_code_message(24).expect("exit code 24 is known");
//! let rendered = template
//!     .to_message()
//!     .with_role(core::message::Role::Receiver)
//!     .to_string();
//!
...
//!
//! ```
//! use core::message::{strings::exit_code_message, Message, Severity};
//!
...
//!
//! ```
//! use core::message::strings::exit_code_severity;
...
/// const REMOTE_SHELL_FAILURE: Option<core::message::strings::ExitCodeMessage> =
...
///
/// ```
/// use core::message::strings::exit_code_messages;
///
