...
//! # Overview
//!
//! `compress` exposes compression primitives shared across the Rust rsync
...
//! surface these diagnostics via the central message facade in `core`.
//!
//! # Examples
//!
...
pub use skip_compress::DEFAULT_SKIP_COMPRESS_SUFFIXES;
#[cfg(feature = "lz4")]
