...
//! # Upstream Reference
//!
//! - `util1.c:1664` - `unsafe_symlink(dest, src)`
...
/// # Upstream Reference
///
/// - `util1.c:1690-1701` - source path depth computation
...
/// # Upstream Reference
///
/// - `util1.c:1703-1717` - destination path depth check
...
/// # Upstream Reference
///
/// - `util1.c:1673-1688` - mid-path dotdot rejection
