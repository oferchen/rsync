...
pub struct GeneratorContext {
    ...
    pub(super) full_paths: Vec<PathBuf>,
    ...
    pub(super) pending_segments: Vec<PendingSegment>,
    /// Whether all incremental file list segments have been sent.
    pub(super) flist_eof_sent: bool,
    ...
    pub(super) flist_writer_cache: Option<FileListWriter>,
    ...
    pub(super) initial_segment_count: Option<usize>,
...
mod tests {
    ...
    use super::flist::apply_permutation_in_place;
    use super::*;
    ...
    fn rdev_to_major_minor_extracts_linux_values() {
        ...
        let rdev: u64 = 8 << 8;
        let (major, minor) = super::flist::rdev_to_major_minor(rdev);
        assert_eq!(major, 8);
        assert_eq!(minor, 0);
    }
