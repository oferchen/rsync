...
impl GeneratorContext {
    ...
    fn resolve_files_from_paths<R: Read>(
        &self,
...
fn read_files_from_local_path(path: &str, from0: bool) -> io::Result<Vec<String>> {
...
mod tests {
    ...
    mod files_from {
        ...
        fn read_files_from_local_path_line_delimited() {
            ...
            let result =
                super::super::read_files_from_local_path(&list_file.to_string_lossy(), false)
                    .unwrap();
        ...
        fn read_files_from_local_path_nul_delimited() {
            ...
            let result =
                super::super::read_files_from_local_path(&list_file.to_string_lossy(), true)
                    .unwrap();
