...
macro_rules! rotl {
    ($x:expr, 3) => { _mm_or_si128(_mm_slli_epi32($x, 3), _mm_srli_epi32($x, 29)) };
    ...
    ($x:expr, 13) => { _mm_or_si128(_mm_slli_epi32($x, 13), _mm_srli_epi32($x, 19)) };
    ($x:expr, 15) => { _mm_or_si128(_mm_slli_epi32($x, 15), _mm_srli_epi32($x, 17)) };
    ($x:expr, 19) => { _mm_or_si128(_mm_slli_epi32($x, 19), _mm_srli_epi32($x, 13)) };
}
