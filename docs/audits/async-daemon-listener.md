...
Per the project's tokio dependency-scope policy (<internal-tool-doc> "Audit
...
- Touching other crates' dependency graphs. `tokio` stays daemon-
  only and feature-gated. Per <internal-tool-doc>, no new tokio leakage into
...
- <internal-tool-doc> "Audit tokio dependency scope" pair (#1818, #1779):
