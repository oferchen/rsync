...
- **impl**: 14 - ACL, BACKUP, CHDIR, CMD, DUP, FILTER, FLIST, GENR, HASH, ICONV, NSTR, OWN, SEND, TIME.
- **partial**: 7 - CONNECT, DEL, DELTASUM, EXIT, IO, PROTO, RECV.
- **missing**: 3 - BIND, FUZZY, HLINK.
...
| G3 | High | open | 3 flags have no production producer (BIND, FUZZY, HLINK). The previously listed ACL, BACKUP, CHDIR, CMD, GENR, HASH, ICONV, NSTR, OWN, and SEND emissions are now wired (D14, I-ACL, I-ICONV, NSTR follow-up, OWN follow-up, D13 RESOLVED, BACKUP RESOLVED, HASH RESOLVED, CMD RESOLVED, CHDIR RESOLVED). Owning crates for the remaining producers: `metadata` (HLINK), `engine` (FUZZY), `rsync_io` (BIND). |
