...
<internal-tool-doc> references `core::session()`, but the actual public entry points on
master are:
...
This honours the project's design pattern guidance from <internal-tool-doc>:
...
- Design pattern guidance: <internal-tool-doc> "Strategy Pattern" and "Dependency
