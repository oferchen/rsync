...
| 29 | `crates/rsync_io/src/ssh/embedded/auth.rs:127-145` (`load_identity_key`) | `russh_keys::load_secret_key` -> sync file read | none | **OK** - local file I/O; bounded by filesystem latency. Record-only. |
