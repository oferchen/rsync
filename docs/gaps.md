...
- **Transfer engine and supporting crates**: the `engine`, `meta`, `filters`, and
  ...
  [`core::client::run_client`](../crates/core/src/client.rs) only performs
  best-effort local copies with permissions and timestamps preserved; delta
  transfer, ownership/xattrs/ACLs, and remote transports remain unavailable.
