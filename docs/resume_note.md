...
- Documentation, branding, and CI guardrails (lint, coverage, packaging, cross-compilation) are established and enforced via the reusable CI workflows (`ci.yml`, `lint.yml`, `test-linux.yml`, and `cross-compile.yml`).
