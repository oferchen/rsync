...
fn top_level_usage() -> String {
    String::from(
        "Usage: cargo xtask <command> [options]\n\nCommands:\n  branding         Inspect workspace branding metadata\n  docs             Build documentation and run doctests\n  enforce-limits   Enforce per-file Rust line count limits\n  no-binaries      Ensure no tracked binaries exist\n  no-placeholders  Detect placeholder markers in Rust sources\n  package          Build distribution packages (deb/rpm)\n  preflight        Validate branding, documentation, and packaging\n  sbom             Generate a CycloneDX SBOM\n  help             Show this help message\n\nRun `cargo xtask <command> --help` to see command-specific options.",
    )
}
